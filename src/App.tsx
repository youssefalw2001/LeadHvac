...
import { fetchLiveSignals, type LiveSignalSet } from './realSignals';
...
const playbooks: Record<Industry, Playbook> = {
  hvac: {
    icon: 'HVAC', gradient: 'orange', services: ['AC Repair', 'Emergency HVAC', 'Furnace Repair', 'Tune-Ups', 'Duct Cleaning'],
    emergencyTitle: 'Emergency AC Repair Spike', emergencySignal: 'Heat and urgent cooling demand', emergencyWhy: 'AC systems fail when temperatures jump. Homeowners searching now are usually ready to call.', emergencyOffer: 'Same-day AC repair appointments', emergencyAction: 'Launch a call-focused Google Search campaign for emergency AC repair terms.',
    lsaTitle: 'Top Placement HVAC Opportunity', lsaSignal: 'High-intent local HVAC searches', lsaWhy: 'HVAC buyers often call the first trusted provider they see.', lsaOffer: 'Verified local HVAC service with fast scheduling', lsaAction: 'Tighten Google Local Services categories, service area, reviews, and call response process.',
    reactivationTitle: 'Past Customer Tune-Up Reactivation', reactivationSignal: 'Seasonal maintenance window', reactivationWhy: 'Past HVAC customers already know the company, so seasonal messages can bring back tune-ups and repairs.', reactivationOffer: 'Priority seasonal system check', reactivationAction: 'Send email and opt-in SMS to past customers, then retarget site visitors.'
  },
  roofing: {
    icon: 'ROOF', gradient: 'blue', services: ['Storm Damage Inspection', 'Roof Repair', 'Roof Leak Repair', 'Roof Replacement', 'Gutter Repair'],
    emergencyTitle: 'Storm Damage Roofing Opportunity', emergencySignal: 'Wind, rain, hail, or roof inspection demand', emergencyWhy: 'After storms, homeowners look for inspections, leak checks, and repair estimates quickly.', emergencyOffer: 'Free storm damage roof inspection', emergencyAction: 'Launch a Google Search campaign around storm damage, roof leak, and inspection searches.',
    lsaTitle: 'Roofing Trust Gap Opportunity', lsaSignal: 'Trust-heavy local roofing searches', lsaWhy: 'Roofing customers care about reviews, verification, photos, and speed.', lsaOffer: 'Verified local roof inspection and repair', lsaAction: 'Improve Local Services profile, review request flow, photos, and service area coverage.',
    reactivationTitle: 'Old Estimate Follow-Up Opportunity', reactivationSignal: 'Unclosed estimates and aging roof concerns', reactivationWhy: 'Many homeowners delay roof work until weather or leaks force action.', reactivationOffer: 'Updated roof repair or replacement estimate', reactivationAction: 'Reactivate old estimates with email, opt-in SMS, and call follow-up.'
  },
  plumbing: {
    icon: 'PLUMB', gradient: 'green', services: ['Drain Cleaning', 'Water Heater Repair', 'Emergency Plumbing', 'Leak Repair', 'Sewer Line Service'],
    emergencyTitle: 'Emergency Plumbing Call Spike', emergencySignal: 'Urgent leak, clog, rain, or cold-weather demand', emergencyWhy: 'Plumbing problems are immediate. Customers often need a same-day answer and a live phone response.', emergencyOffer: 'Same-day plumbing service', emergencyAction: 'Launch a Google Search campaign for emergency plumber, drain cleaning, and water heater terms.',
    lsaTitle: 'Local Plumber Top Placement Opportunity', lsaSignal: 'High-trust local plumbing searches', lsaWhy: 'Plumbing buyers compare trust signals fast.', lsaOffer: 'Verified local plumber with fast scheduling', lsaAction: 'Optimize LSA categories, hours, service radius, review count, and call handling.',
    reactivationTitle: 'Water Heater Reactivation Opportunity', reactivationSignal: 'Past customers and replacement timing', reactivationWhy: 'Past customers with older water heaters or recurring issues are easier to convert than cold prospects.', reactivationOffer: 'Water heater check or drain cleaning offer', reactivationAction: 'Send opt-in SMS/email to past customers and retarget website visitors.'
  },
  electrical: {
    icon: 'ELEC', gradient: 'purple', services: ['Panel Upgrade', 'Emergency Electrician', 'EV Charger Install', 'Outlet Repair', 'Generator Install'],
    emergencyTitle: 'Same-Day Electrical Service Opportunity', emergencySignal: 'Urgent electrician and safety-related searches', emergencyWhy: 'Electrical issues feel risky to homeowners. Fast, trusted messaging can turn urgent searches into calls.', emergencyOffer: 'Same-day electrical troubleshooting', emergencyAction: 'Launch a Google Search campaign for emergency electrician and panel issue terms.',
    lsaTitle: 'Verified Electrician Trust Opportunity', lsaSignal: 'Trust-driven electrician searches', lsaWhy: 'Electricians benefit from visible verification, reviews, and fast response.', lsaOffer: 'Verified local electrical service', lsaAction: 'Improve LSA service categories, business hours, review flow, and lead response.',
    reactivationTitle: 'Panel and EV Charger Reactivation', reactivationSignal: 'Past estimate and upgrade interest', reactivationWhy: 'Upgrade work often takes follow-up. Customers who asked before may convert with a clear offer.', reactivationOffer: 'Panel upgrade or EV charger estimate', reactivationAction: 'Follow up with past estimates using email, opt-in SMS, and retargeting.'
  },
  pest: {
    icon: 'PEST', gradient: 'teal', services: ['Pest Control', 'Termite Treatment', 'Rodent Control', 'Wasp Removal', 'Bed Bug Inspection'],
    emergencyTitle: 'Pest Activity Spike', emergencySignal: 'Humidity, warmth, and urgent removal demand', emergencyWhy: 'Pest problems create urgency and discomfort. Customers want fast scheduling and clear pricing.', emergencyOffer: 'Fast pest inspection and treatment', emergencyAction: 'Launch a Google Search campaign for urgent pest control and treatment terms.',
    lsaTitle: 'Pest Control Trust Opportunity', lsaSignal: 'Local service searches where trust matters', lsaWhy: 'Pest buyers compare providers quickly.', lsaOffer: 'Verified local pest treatment', lsaAction: 'Optimize LSA services, photos, reviews, and response process.',
    reactivationTitle: 'Seasonal Pest Plan Reactivation', reactivationSignal: 'Past customers entering seasonal pest window', reactivationWhy: 'Past pest customers are strong reactivation targets when seasonal activity returns.', reactivationOffer: 'Seasonal pest protection visit', reactivationAction: 'Send email and opt-in SMS to previous customers and retarget site visitors.'
  },
  garage: {
    icon: 'DOOR', gradient: 'slate', services: ['Garage Door Repair', 'Spring Replacement', 'Opener Repair', 'Emergency Garage Door', 'New Door Install'],
    emergencyTitle: 'Garage Door Repair Demand Spike', emergencySignal: 'Urgent broken spring and stuck door searches', emergencyWhy: 'Garage door problems block cars and daily routines. Customers usually want same-day help.', emergencyOffer: 'Same-day garage door repair', emergencyAction: 'Launch a Google Search campaign for broken spring, stuck door, and opener repair terms.',
    lsaTitle: 'Garage Door Top Placement Opportunity', lsaSignal: 'High-intent repair searches', lsaWhy: 'Fast response and trust signals matter when a garage door is stuck or unsafe.', lsaOffer: 'Verified local garage door repair', lsaAction: 'Optimize LSA categories, hours, review flow, and service areas.',
    reactivationTitle: 'Past Repair Maintenance Reactivation', reactivationSignal: 'Past customers due for service or opener upgrades', reactivationWhy: 'Customers with prior garage door issues may need tune-ups or replacements.', reactivationOffer: 'Garage door safety and tune-up visit', reactivationAction: 'Reactivate past customers with email, opt-in SMS, and retargeting.'
  }
};
...
function App() {
  ...
  const [liveSignals, setLiveSignals] = useState<LiveSignalSet | null>(null);
...
function OpportunityRadar({ go, scan, setScan, liveSignals, setLiveSignals, openCampaign }: { go: (r: Route) => void; scan: ScanInput; setScan: (input: ScanInput) => void; liveSignals: LiveSignalSet | null; setLiveSignals: (signals: LiveSignalSet | null) => void; openCampaign: (opportunity: Opportunity) => void }) {
  ...
  useEffect(() => {
    ...
    fetchLiveSignals({ industry: draft.industry, city: draft.city, service: draft.service }).then((signals) => {
      if (!cancelled) setLiveSignals(signals);
    }).catch(() => {
      if (!cancelled) setLiveSignals(null);
    }).finally(() => {
      if (!cancelled) setLoadingSignals(false);
    });
    return () => { cancelled = true; };
  }, [draft.industry, draft.city, draft.service, setLiveSignals]);

  const opportunities = useMemo(() => buildOpportunities(draft, liveSignals), [draft, liveSignals]);
...
function scoreOpportunity(launchType: LaunchType, industry: Industry, signals: LiveSignalSet | null): OpportunityScore {
  const searchScore = signals?.search.score || 76;
  const weatherBoost = signals?.weather?.triggers.length ? 4 : 0;
  const weatherUrgency = launchType === 'google-search' ? weatherBoost : launchType === 'lsa' ? Math.floor(weatherBoost / 2) : 0;
  const base: Record<LaunchType, Omit<OpportunityScore, 'total'>> = {
    'google-search': { urgency: Math.min(25, 20 + weatherUrgency), searchIntent: Math.min(25, Math.round(searchScore / 4)), competitionGap: 15, revenuePotential: 14, launchReadiness: 8, difficultyPenalty: 4 },
    lsa: { urgency: 18 + weatherUrgency, searchIntent: Math.min(25, Math.round(searchScore / 4)), competitionGap: 18, revenuePotential: 14, launchReadiness: 7, difficultyPenalty: 6 },
